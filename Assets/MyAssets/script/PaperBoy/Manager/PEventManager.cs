 ...
 */
public class PEventManager : MonoBehaviour
{
	void Awake()
	{
		Init();
	...
	public PEventManager() { s_Instance = this; }
	public static PEventManager Instance { get { return s_Instance; } }
	private static PEventManager s_Instance;
}
//
